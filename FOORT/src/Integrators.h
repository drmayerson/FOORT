 ...
 * @brief Declarations of integrator functions that integrate geodesic equation
 * @version 0.1
 * @date 2025-01-14
...
//! Forward declaration needed of Source (Source is declared in Geodesic.h, but we want to avoid a header loop!)
class Source;

// This is the structure of a function that integrates the geodesic equation one step
